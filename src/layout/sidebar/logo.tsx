      ...
      <svg
		...
		c-17.1,135-34.2,270-51.3,405"
          ...
          <path
            id="front1"
            className="st1"
            d="M827.65,2390.95c-74.25,0-148.5,0-222.75,0c-3.69-0.1-17.91-0.94-29.7-12.15
		c-15.6-14.84-13.77-35.31-13.5-37.8c-0.99-55.35-1.98-110.7-2.97-166.05c-0.54-19.57,1.56-54.91,24.57-85.05
		c16.1-21.08,35.78-30.91,47.25-36.45c82.89-40.03,211.65-85.46,233.55-93.15"
          />
          <path
            id="front2"
            className="st0"
