...
export class GtfsService {
     ...
     * @throws ApiError
     */
    public static getGtfsRoutesGetGet(
        id: number,
    ): CancelablePromise<GtfsRoutePydanticModel> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/gtfs_routes/get',
            query: {
     ...
     * @throws ApiError
     */
    public static getGtfsStopsGetGet(
        id: number,
    ): CancelablePromise<GtfsStopPydanticModel> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/gtfs_stops/get',
            query: {
     ...
     * @throws ApiError
     */
    public static getGtfsRidesGetGet(
        id: number,
    ): CancelablePromise<GtfsRidePydanticModel> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/gtfs_rides/get',
            query: {
     ...
     * @throws ApiError
     */
    public static getGtfsRideStopsGetGet(
        id: number,
    ): CancelablePromise<GtfsRideStopPydanticModel> {
        return __request(OpenAPI, {
            method: 'GET',
