...
import { ROUTE_COLORS } from 'src/pages/components/map-related/map-types'
...
const meta = {
  ...
  argTypes: {
    positionGroups: {
      control: 'object',
      description: 'Position groups for rides on the line profile.',
      table: {
    ...
    positionGroups: [
      {
        positions: [
          {
            loc: [ridePoint.lat, ridePoint.lon],
            color: ridePoint.velocity,
            operator: ridePoint.siriRouteOperatorRef,
            bearing: ridePoint.bearing,
            point: ridePoint,
          },
        ],
        color: ROUTE_COLORS[0],
        vehicleRef: ridePoint.siriRideVehicleRef,
      },
    ],
  },
}
