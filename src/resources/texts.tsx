...
export const TEXT_KEYS = {
  ...
  group_by_default_tooltip_content: 'group_by_default_tooltip_content',
  start: 'start',
  end: 'end',
...
export const TEXTS = {
  ...
  dashboard_page_graph_title_time: 'אחוזי יציאה מסך הנסיעות לפי זמן',
  ...
  group_by_default_tooltip_content: 'קיבוץ לפי זמן',
